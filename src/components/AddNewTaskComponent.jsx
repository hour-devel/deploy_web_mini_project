...
import { tastAction } from "@/actions/taskAction";
import Image from "next/image";
import React from "react";

export default async function AddNewTaskComponent({pathName,workSpaceId}) {
  return (
        ...
        <div className="modal-box">
          <div>
            <h3 className="text-gray">
              Workspace &gt; <span>{pathName.workspaceName}</span>
            </h3>
          ...
          <form action={tastAction} className="space-y-1" >
